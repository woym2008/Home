...
public class PlayerLighting : MonoBehaviour
{
    ...
    Color oricolor = new Color(0.196f, 0.192f, 0.282f, 0);
    ...
    const float maxdis = 8.4f;

    public void UpdateAlpha(float dis)
    {
        float alpha = 0;
        if(dis > maxdis)
        {
        ...
        //oricolor = _lineRender.material.color;
        oricolor.a = alpha;
        _lineRender.material.SetColor("_TintColor", oricolor);
    }
}
